    ...
    if (self.scrollView){
        ...
        dispatch_async(imageFetchQ, ^{
            ...
            if (!imageData){    // Not found in the cache, go get it off the Net... 
                ...
                [NetworkIndicatorHelper setNetworkActivityIndicatorVisible:YES]; // Start the network indicater spinning wheel!
                imageData = [[NSData alloc] initWithContentsOfURL:self.imageURL];
                [NetworkIndicatorHelper setNetworkActivityIndicatorVisible:NO]; // Stop the network indicater spinning wheel!
